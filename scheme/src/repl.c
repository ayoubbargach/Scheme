...
void init_interpreter ( void ) {
   ...
   nil      = make_nil(); /* on initialise empty_list qui est la meme chose que nil */
   true = make_boolean(); /* on initialise true */
   false =make_boolean(); /* on initialise false*/
...
int main ( int argc, char *argv[] ) {
    ...
    while ( 1 ) {
       ...
       /* printf("%s\n", input );          enlevez les commentaires quand step 0 est accomplie
        continue; */
